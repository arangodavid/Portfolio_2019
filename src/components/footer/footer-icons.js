	...
	return (
		<ul className="social_icon_cont">
			<li className="social_icon">
				<a className="social_icon_link" 
				href="https://github.com/arangodavid" 
			...
			<li className="social_icon">
				<a className="social_icon_link" 
				href="https://www.linkedin.com/in/david-arango-435037134/" 
				rel="noopener noreferrer" 
				target="_blank"
				>
					<svg 
			...
			<li className="social_icon">
				<a className="social_icon_link" 
				href="https://codepen.io/ComputingDoneRight/pens/popular/" 
				rel="noopener noreferrer" 
				target="_blank"
				>
					<svg 
